...
//import com.example.nfclastdemo.bean.DemoBean;
        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    //2222
                    Statistics statistics = (Statistics) objList.get(j);
                    List<String> list = new ArrayList<>();
                    list.add(statistics.getEmployeeId());
                    list.add(statistics.getName());
                    list.add(statistics.getDate());
                    list.add(statistics.getIs_complete());
                    list.add(statistics.getRemark());
